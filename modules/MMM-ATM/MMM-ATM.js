...
Module.register("MMM-ATM", {
    ...
    getDom: function() {
        ...
        if (this.config.useHeader != false) {
            ...
            header.classList.add("medium", "bright", "light", "header");
        ...
        if (ATMKeys.length > 0) {
            ...
            while (this.ATM[ATMKeys[this.activeItem]].category == "Entertainment: Video Games" && this.activeItem < ATMKeys.length - 1) {
                this.activeItem++
            }
            ...
            question.classList.add("medium", "bright", "question");
            ...
            answer1.classList.add("medium", "bright", "answer1");
            ...
            answer2.classList.add("medium", "bright", "answer2");
            if (ATM.type !== "multiple") {
                answer2.innerHTML = "";
            ...
            answer3.classList.add("medium", "bright", "answer3");
            if (ATM.type !== "multiple") {
                answer3.innerHTML = "";
            ...
            answer4.classList.add("medium", "bright", "answer4");
            if (ATM.type !== "multiple") {
                answer4.innerHTML = "";
